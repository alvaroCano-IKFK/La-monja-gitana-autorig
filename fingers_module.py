...
class FingersModule(object):
    ...
    def build_finger_from_guides(self, guide_root):
        """Construye una cadena de joints para un dedo a partir de su guía raíz."""
    ...
    def build(self):
        ...
        # ---- ORGANIZACIÓN FINAL (igual que LimbModule) ----
        if self.side == "R":
            # Lado R: va bajo mirrorBehaviour_GRP (scaleX -1)
