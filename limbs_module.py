...
class LimbModule(object):
    ...
    def build(self):
        ...
        if cmds.objExists(self.arm_grp):
            ...
            cmds.parent(f"{self.side}_armUpperStart_NR_JNT", self.arm_grp)
            cmds.parent(f"{self.side}_armUpper_NR_IKH", self.arm_grp)
            cmds.parent(f"{self.side}_armLowerStart_NR_JNT", self.arm_grp)
            cmds.parent(f"{self.side}_armLower_NR_IKH", self.arm_grp)
